...
export default function Home() {
    return (
        <main className="items-center">
            ...
            <header className="grid grid-cols-2 mt-12 ml-4">
                <div className="relative overflow-hidden w-100 h-80 rounded-3xl cursor-pointer text-2xl font-bold bg-blue-400 mt-4">
                ...
                <Image src="/plotter.jpg" width={900} height={1100} alt="não foi" className=" m-4 rounded-md"/>
            </header>
            ...
            <button className="group flex justify-center items-center gap-2 group-hover:before:duration-500 group-hover:after:duration-500 after:duration-500 hover:border-neutral-900
                          ...
                          after:content[''] after:bg-sky-900 after:-left-8 after:top-8 after:rounded-full after:blur-lg hover:after:animate-pulse">
                <svg
